...
<body onFocus="parent_disable();" onclick="parent_disable();">
	...
	<div id="plan" style="width: 700px; margin: 0 auto;">
		...
		<%}
					...
					ResultSet rtw = null;
					String q4 = "Select * from result_edge where building_name = 'lib' and scenario_name='scene1' and algorithm='CCRP-extended'";/* session.getAttribute("building_name") */

					rtw = (st.executeQuery(q4));
					while (rtw.next()) {
				  
						  String plm =rtw.getString("edge_name");
					        %>
					    	    var ppp ="<%=plm%>";
					    	    d3.select("#"+ppp).style("stroke","red");
					    	  <%
					      }
