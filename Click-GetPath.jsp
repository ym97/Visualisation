...
<body onFocus="parent_disable();" onclick="parent_disable();">
	...
	<div id="plan" style="width: 700px; margin: 0 auto;">
		...
		<%}
					...
					ResultSet rtw = null;
					String q4 = "Select * from scenario_node where building_name = 'lib' and scenario_name='scene1' ";/* session.getAttribute("building_name") */

					// add floor number also in the query

					rtw = (st.executeQuery(q4));
					while (rtw.next()) {
				  
						  String plm =rtw.getString("node_id");
					      String type= rtw.getString("node_type");
